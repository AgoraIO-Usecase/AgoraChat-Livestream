 ...
 * (1) Join the live room and set the state to live broadcast. The callback method is {@link #onStartBroadcast()}
 * (2) Obtain the agora token (if necessary) successfully, and join the channel, the specific method is {@link #joinRtcChannel(String)}
 */
